...
import com.oladriver.conductores.AccountverificationActivity;
import com.oladriver.conductores.ActiveTripActivity;
import com.oladriver.conductores.AdditionalChargeActivity;
import com.oladriver.conductores.AllPermissionsHandleActivity;
import com.oladriver.conductores.CollectPaymentActivity;
import com.oladriver.conductores.DriverArrivedActivity;
import com.oladriver.conductores.MainActivity;
import com.oladriver.conductores.SuspendedDriver_Activity;
import com.oladriver.conductores.TripRatingActivity;
import com.oladriver.conductores.ViewMultiDeliveryDetailsActivity;
...
//        generalFun.storeData(storeData);
    ...
    public void startProcess() {
        ...
        if (generalFun.getJsonValueStr ( "RIDE_DRIVER_CALLING_METHOD", userProfileJsonObj). equalsIgnoreCase ("Voip"))
        ...
        if (!generalFun.isAllPermissionGranted (false, requestPermissions)) {
            ...
            new StartActProcess (mContext). startActWithData ( AllPermissionsHandleActivity.class, bn);
