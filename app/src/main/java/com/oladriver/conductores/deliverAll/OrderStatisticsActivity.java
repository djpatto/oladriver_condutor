package com.oladriver.conductores.deliverAll;
...
public class OrderStatisticsActivity extends AppCompatActivity {
    ...
    androidx.appcompat.app.AlertDialog list_year;
    String TotalEarning = "";
    String OrderCount = "";
...
//        titleTxt.setText(generalFunc.retrieveLangLBl("Trip Statistics", "LBL_STATISTICS_DRDL"));
        titleTxt.setText(generalFunc.retrieveLangLBl("", "LBL_TRIP_STATISTICS_TXT_DL"));
        totalearnHTxt.setText(generalFunc.retrieveLangLBl("", "LBL_TOTAL_EARNINGS"));
        noTripHTxt.setText(generalFunc.retrieveLangLBl("", "LBL_NUMBER_OF_TRIPS_DRDL"));
        yearBox.setBothText(generalFunc.retrieveLangLBl("", "LBL_YEAR"), generalFunc.retrieveLangLBl("", "LBL_CHOOSE_YEAR"));
    }

    public Context getActContext() {
        return OrderStatisticsActivity.this;
    }
            ...
            public void setResponse(String responseString) {
                ...
                if (responseStringObject != null && !responseStringObject.equals("")) {
                    ...
                    if (generalFunc.checkDataAvail(Utils.action_str, responseStringObject) == true) {
                        OrderCount = generalFunc.convertNumberWithRTL(generalFunc.getJsonValueStr("OrderCount", responseStringObject));
                        String MaxEarning = generalFunc.convertNumberWithRTL(generalFunc.getJsonValueStr("MaxEarning", responseStringObject));
                        TotalEarning = generalFunc.convertNumberWithRTL(generalFunc.getJsonValueStr("TotalEarning", responseStringObject));
                        selectedyear = generalFunc.convertNumberWithRTL(generalFunc.getJsonValueStr("CurrentYear", responseStringObject));
                        JSONArray YearMonthArr = generalFunc.getJsonArray("YearMonthArr", responseStringObject);
                        listData.clear();
                        monthList.clear();
                        ...
                        JSONArray yeararray = generalFunc.getJsonArray("YearArr", responseStringObject);
    ...
    public class setOnClickList implements View.OnClickListener {
        ...
        public void onClick(View view) {
            int i = view.getId();
            Utils.hideKeyboard(OrderStatisticsActivity.this);
