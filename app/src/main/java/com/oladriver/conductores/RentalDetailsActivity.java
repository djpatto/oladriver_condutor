package com.oladriver.conductores;
...
public class RentalDetailsActivity extends AppCompatActivity implements PackageAdapter.setPackageClickList, OnMapReadyCallback, GetLocationUpdates.LocationUpdatesListener {
